...
//        Permission::create(['name' => '删除渠道','guard_name' => 'admin']);
        ...
        Permission::create(['name' => '产品列表','guard_name' => 'admin']);
        ...
        Permission::create(['name' => '页面列表','guard_name' => 'admin']);
        ...
        Permission::create(['name' => '推广列表','guard_name' => 'admin']);
